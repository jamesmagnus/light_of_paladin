...
public:
    ...
    Vetement(Ogre::SceneNode *pNode, EShape shapeType, int prix=0, float poid=1.0, std::string const& nom="defaultClothe", bool IsUnique=false, bool IsVisible=true, Sort *pEnchantement=nullptr);
