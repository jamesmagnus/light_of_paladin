...
/* Sémantique d'entité */
class Item: public Affichable, public Collisionnable
{
protected:
...
public:
	...
	Item(Ogre::SceneNode *pNode, EShape shapeType, int prix=0, float poid=1.0, std::string const& nom="defaultItem", bool IsUnique=false, bool IsVisible=true);
